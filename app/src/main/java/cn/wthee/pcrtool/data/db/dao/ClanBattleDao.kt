...
ELSE 
CASE WHEN a.clan_battle_id % 100 > 11 THEN a.clan_battle_id % 100 = b.enemy_id / 100 % 100 AND b.enemy_id % 100000 / 10000 > 1 AND a.boss_id % 100 = b.enemy_id % 100
ELSE 
CASE WHEN  a.clan_battle_id % 100 > 9 THEN a.clan_battle_id % 100 = b.enemy_id / 100 % 100 AND b.enemy_id % 100000 / 10000 > 0  AND a.boss_id % 100 = b.enemy_id % 100
ELSE 
